...
require_once dirname(__DIR__) . '/../lib/api_sdk/vendor/autoload.php';
...
class SmsDAL {
    ...
    public static function sendSms($phone, $code, $orderid) {
        ...
        $request->setSignName("太歌注册验证");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_120095045");
     ...
     * @return stdClass
     */
    public static function querySendDetails($phone, $date, $bizid) {
