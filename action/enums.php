...
class enums {
    ...
    function index() {
        ...
        try {
            ...
            self::$data['data'] = EnumDAL::getAll($currentPage, $pagesize, $keywords, $this->enterprise_id);
            self::$data['total'] = EnumDAL::getTotal($keywords, $this->enterprise_id);
    ...
    function getEnum() {
        ...
        try {
            if ($id != null) {
                self::$data['data'] = EnumDAL::getOne($id);
            } else {
                self::$data['data'] = null;
            }
            self::$data['class'] = $this->class;
    ...
    function updateEnum() {
        ...
        try {
            if ($id != null) {
                ...
                self::$data = EnumDAL::update($id, $data);
            } else {
